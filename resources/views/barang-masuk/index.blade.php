    ...
    <div class="content-section">
        <div class="content-section-header">
            ...
            <div class="flex flex-wrap items-center gap-3">
                <form action="{{ route('barang-masuk.index') }}" method="GET" class="flex items-center gap-2">
                    ...
                    @if(request('dari') || request('sampai'))
                        <a href="{{ route('barang-masuk.index') }}" class="btn btn-ghost text-xs !py-2 px-2">Reset</a>
                    @endif
                </form>

                <a href="{{ route('laporan.barang-masuk', ['dari' => request('dari'), 'sampai' => request('sampai')]) }}" target="_blank" class="btn bg-emerald-50 text-emerald-600 hover:bg-emerald-100 border border-emerald-200 shadow-sm">
